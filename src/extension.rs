...
mod tests {
    ...
    fn from_bytes_to_extension() {
        let bytes: [u8; 161] = [
            ...
            105, 111, 110, 32, 50, 46, 57, 52, 101, 0, 0, 0, 33, 5, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
            255, 255, 255, 255, 255, 255, 255, 255, 192,
        ];

        // d1:ei1e1:md11:ut_metadatai3e6:ut_pexi1ee13:metadata_sizei5205e1:pi51413e4:reqqi512e11:upload_onlyi1e1:v17:Transmission 2.94e\0\0\0!\u{5}��������������������������������
